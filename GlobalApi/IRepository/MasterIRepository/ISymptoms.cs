...
namespace GlobalApi.IRepository.MasterIRepository
{
    public interface ISymptoms
    {
        ...
        Task<string> InsertManualSymptoms(List<Symptoms> lead, int MAppt_Id);

        Task<bool> UpdateSymptomstest(List<Symptoms> lead, int Appt_Id);
        Task<bool> UpdateManualSymptoms(List<Symptoms> lead, int MAppt_Id);

        Task<List<GetAllSymptoms>> GetAllSymptoms();
        Task<List<GetAllSymptoms>> GetAllManualSymptoms();
