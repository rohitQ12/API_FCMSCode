...
namespace GlobalApi.IRepository.MasterIRepository
{
    public interface IAllergySigns_DTL
    {
        ...
        Task<string> InsertPHCAllergySigns_DTL(List<AllergySigns_DTL> lead, int Appt_Id);
        Task<bool> UpdateAllergySigns_DTLtest(List<AllergySigns_DTL> lead, int Appt_Id);
        Task<bool> UpdatePHCAllergySigns_DTL(List<AllergySigns_DTL> lead, int Appt_Id);
        Task<List<GetAllAllergySigns_DTL>> GetAllAllergySigns_DTL();
        Task<List<GetAllAllergySigns_DTL>> GetAllPHCAllergySigns_DTL();
