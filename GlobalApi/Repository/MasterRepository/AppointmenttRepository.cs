...
namespace GlobalApi.Repository.MasterRepository
{
    public class AppointmenttRepository : IAppointment
    {
        ...
        public async Task<string> ApproveAppointment(ApproveAppointment lead)
        {
            try
            {
                ...
                if (result != null)
                {
                    if (consdate == Aptdate)
                    {
                        if (time >= AptFrmTime && time <= AptToTime)
                        {
                            ...
                            return "Appoinment Approved Sucessfully";
        ...
        //}
        public async Task<List<GetAllAppointmentModel>> GetAllAppointment(int HospitalId, int DoctorId, string roleaction, string rolename)
        {
            try
            {
                if (db != null)
