...
namespace GlobalApi.Repository.MasterRepository
{
    public class DoctorRepository : IDoctor
    {
        ...
        public async Task<string> InsertDoctor(Doctor_Images lead, string UserId)
        {
            try
            {
                ...
                return "Doctor MobileNumber Already Exists";
        ...
        public async Task<string> UpdateDoctor(Doctor_ImagesUP lead)
        {
            try
            {
                ...
                if (Doctor.DO_MobileNumber != lead.DO_MobileNumber)
                {
                    if (Doctor.DO_Email != lead.DO_Email)
                    {
                        ...
                        {
                            if (Doctor.DO_Photo != null && Doctor.DO_Photo != "user-1633249__340 (1).png")
                            {
                                string filepath = Path.Combine("wwwroot/Doctor", Doctor.DO_Photo);
                                System.IO.File.Delete(filepath);
                            }

                        }
                        //Update DoctorRegistration logo
                        string uniqueFilename = lead.DO_Photo != null ? ProcessUploadedFileUP(lead) : Doctor.DO_Photo;

                        if (Doctor != null)
                        {

                            Doctor.DO_Id = lead.DO_Id;
                            Doctor.DO_Code = lead.DO_Code;
                            Doctor.DO_FirstName = lead.DO_FirstName;
                            Doctor.DO_LastName = lead.DO_LastName;
                            Doctor.DO_DOB = lead.DO_DOB;
                            Doctor.DO_Gender = lead.DO_Gender;
                            Doctor.DO_MotherTongue = lead.DO_MotherTongue;
                            Doctor.DO_Address = lead.DO_Address;
                            Doctor.DO_Country_Id_FK = lead.DO_Country_Id_FK;
                            Doctor.DO_ST_Id_FK = lead.DO_ST_Id_FK;
                            Doctor.DO_DI_Id_FK = lead.DO_DI_Id_FK;
                            Doctor.DO_Taluk_Id = lead.DO_Taluk_Id;
                            Doctor.DO_Gram_Id = lead.DO_Gram_Id;
                            Doctor.DO_PostalCode = lead.DO_PostalCode;
                            Doctor.DO_MobileNumber = lead.DO_MobileNumber;
                            Doctor.DO_OfficialNumber = lead.DO_OfficialNumber;
                            Doctor.DO_Email = lead.DO_Email;
                            Doctor.DO_HO_Id_FK = lead.DO_HO_Id_FK;
                            Doctor.DO_QU_Id_FK = lead.DO_QU_Id_FK;
                            Doctor.DO_DE_Id_FK = lead.DO_DE_Id_FK;
                            Doctor.DO_CD_Id_FK = lead.DO_CD_Id_FK;
                            Doctor.DO_SP_Id_FK = lead.DO_SP_Id_FK;
                            Doctor.DO_Photo = uniqueFilename;
                            Doctor.DO_UserId_FK = lead.DO_UserId_FK;
                            Doctor.DO_Village = lead.DO_Village;
                            Doctor.DO_Alernative_Numb = lead.DO_Alernative_Numb;
                            Doctor.PANno = lead.PANno;
                            Doctor.GSTno = lead.GSTno;
                            Doctor.Regno = lead.Regno;
                            Doctor.modified_by = 2;
                            Doctor.modified_date = DateTime.Now;
                            Doctor.delete_flag = false;
                            Doctor.status = 2;
                            await db.SaveChangesAsync();
        ...
        public async Task<string> DeleteDoctor(int DO_Id)
        {
            try
            {
