    ...
    public class AllowedMenusRepository: IAllowedMenusRepository
    {
        ...
        public async Task<List<Menus_List>> Get(string roleId)
        {
            try
            {
                ...
                var _result = (from a in db.Menus
                                   //join b in db.SubMenu on a.M_Id equals b.SM_M_Id_FK 
                               join c in db.RoleClaims on a.M_Id equals c.RC_M_Id_FK
                               ...
                               select new Menus_List()
                               {
                                   ...
                                   subItems = ((from d in db.SubMenu
                                                ...
                                                select new SubMenu_List
                                                {
                                                    ...
                                                    subItemsList = ((from g in db.SubMenu
                                                                     join h in db.SubMenusFunctions on g.SM_Id equals h.SMF_SM_Id_FK
                                                                     join i in db.SubRoleClaims on h.SMF_Id equals i.SRC_SMF_Id_FK
        ...
        public async Task<List<ClaimsModels>> GetClims(string submenuname,string roleId)
        {
            try
            {
