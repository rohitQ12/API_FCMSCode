...
namespace GlobalApi
{
    ...
    {
        public const string ApiName = "Global_api";
        public const string ApiFriendlyName = "Global API";
        public const string QuickAppClientID = "Global_spa";
        public const string SwaggerClientID = "swaggerui";
        public const string ApiSecret = "ByYM000OLlMQG6VVVp1OH7Xzyr7gHuw1qvUC5dcGt3SNM";
        ...
        public static IEnumerable<ApiResource> GetApiResources_test()
        {
            return new List<ApiResource>
            {
        ...
        public static IEnumerable<Client> GetClients_test()
        {
